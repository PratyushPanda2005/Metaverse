  ...
  >
    ...
    >
      ...
      <div>
        ...
        <p className="mt-[8px] sm:text-[18px] text-[12px] sm:leading-[22px] leading-[16px] font-normal text-white">
          Founder | Metaverse
        </p>
      </div>
      <p className="mt-[24px] sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] font-normal text-white">"With the development of today's technology, metaverse is very useful for today's work, or can be called Web 3.0 by using metaverse you can use it as anything.</p>
    </motion.div>
    <motion.div
